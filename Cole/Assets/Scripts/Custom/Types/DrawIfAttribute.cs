...
public class DrawConditionedFieldAttribute : PropertyAttribute
{
    ...
    public DrawConditionedFieldAttribute(string comparedPropertyName, object comparedValue, ComparisonType comparisonType, DisablingType disablingType = DisablingType.DontDraw)
    {
