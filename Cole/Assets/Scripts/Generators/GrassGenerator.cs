using UnityEngine;
using UnityEditor;
namespace ProjectFukalite.Generators
{
    #if UNITY_EDITOR
    public class GrassGenerator : ScriptableWizard
    {
        ...
        static void createWizard()
        {
            ...
            ScriptableWizard.DisplayWizard("Select terrain to put grass on", typeof(GrassGenerator), "Place Grass on Terrain");
