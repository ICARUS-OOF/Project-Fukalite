...
using ProjectFukalite.Custom.Types;
using ProjectFukalite.Custom.Exceptions;
using ProjectFukalite.Utils;
[CustomPropertyDrawer(typeof(DrawConditionedFieldAttribute))]
public class DrawIfPropertyDrawer : PropertyDrawer
{
    // Reference to the attribute on the property.
    DrawConditionedFieldAttribute drawIf;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        drawIf = attribute as DrawConditionedFieldAttribute;
